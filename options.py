...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--retweets_range', nargs='+', type=int, required=True, help='retweets range list')
        parser.add_argument('--likes_range', nargs='+', type=int, required=True, help='likes range list')
